...
VX:{
"^":"Tp:0;c",
call$1:function(a){return this.c(a)}}}],["board","file:///Users/Alex/Documents/Projects/Dart/RogueTest/RogueTest/web/board.dart",,B,{
"^":"",
cp:{
"^":"a;CE,Hs,kX",
...
for(z=this.kX,y=0;y<$.kZ;++y)for(x=0;x<$.vR;++x){w=$.A7
v=$.rb
if(y>=v.length)return H.e(v,y)
v=v[y]
if(x>=v.length)return H.e(v,x)
w.t(0,v[x]).it(a,new A.HE(x,y),z)}$.iH().VF(a,z)
z=$.Tn()
z.toString
H.bQ(z,new B.HF(this,a))},
Gp:function(a){var z,y,x,w,v,u,t,s,r,q
z=J.RE(a)
y=z.gR(a)
x=$.ae
...
this.Hs=C.jn.Z(z,x)
$.A7=P.L5(null,null,null,J.im,K.ly)
$.rb=H.VM(Array($.kZ),[[J.Q,J.im]])
w={}
for(w.b=0,v=0;z=w.b,z<$.kZ;u={},z=w.b,u.b=z,u.b=z+1,w=u){y=$.rb
x=Array($.vR)
x.$builtinTypeInfo=[J.im]
if(z>=y.length)return H.e(y,z)
y[z]=x
t={}
for(t.a=0;z=t.a,y=$.vR,x=$.rb,s=w.b,z<y;r={},z=t.a,r.a=z,r.a=z+1,t=r){if(s>=x.length)return H.e(x,s)
y=x[s]
x=$.SC
if(v<0||v>=x.length)return H.e(x,v)
x=H.BU(x[v],null,null)
if(z>=y.length)return H.e(y,z)
y[z]=x;++v
x=$.A7
z=$.rb
...
z=t.a
if(z>=y.length)return H.e(y,z)
x.to(y[z],new B.U9(w,t))}if(s>=x.length)return H.e(x,s)
q=H.d(x[s])
H.qw(q)}$.Tn().push(A.tB("ghost",new A.HE(3,3)))
this.kX.N=$.iH()},
static:{"^":"ae,Nd,Yp,A7,rb,vR,kZ,re,nB",Pz:function(a){var z=new B.cp(null,null,new T.mN(new A.HE(0,0),null))
z.Gp(a)
return z},AL:function(a){var z,y
z={}
z.a=!1
y=$.Tn()
y.toString
...
x=$.Nd
w=new K.ly(z,null)
w.Mp=L.DM($.kE().t(0,z).t(0,"name"),y,x,null,null)
return w}},
jg:{
"^":"Tp:8;a,b",
...
z=J.My(a)
y=this.b
if(J.Rd(z)===y.x&&z.y===y.y)if(a.gl7()===!0)this.a.a=!0}},
xI:{
"^":"Tp:8;a",
call$1:function(a){a.eC(this.a)}},
On:{
"^":"Tp:7;b",
call$2:function(a,b){b.eC(this.b)}},
HF:{
"^":"Tp:8;a,b",
...
"^":"",
am:function(){$.ST().u(0,"Player_Move",new F.ux())},
jR:{
"^":"a;"},
ux:{
"^":"Tp:10;",
call$1:function(a){return new F.cH(a,null)}},
cH:{
"^":"jR;j8,eT",
...
y=J.RE(z)
x=y.gbM(z)
w=new A.HE(J.Rd(x),x.y)
if(K.ZD(87))w.y=J.U5(y.gbM(z))-1
else if(K.ZD(65))w.x=J.Rd(y.gbM(z))-1
else if(K.ZD(83))w.y=J.U5(y.gbM(z))+1
else if(K.ZD(68))w.x=J.Rd(y.gbM(z))+1
if(!B.AL(w)){x=w.x
if(!(x<0)){v=w.y
if(!(v<0))if(!(x>=$.vR))if(!(v>=$.kZ)){u=$.A7
t=$.rb
if(v>>>0!==v||v>=t.length)return H.e(t,v)
v=t[v]
if(x>>>0!==x||x>=v.length)return H.e(v,x)
x=u.t(0,v[x]).bz()!==!0}else x=!0
else x=!0
else x=!0}else x=!0}else x=!0
if(!x||!1){x=w.x
v=y.gbM(z)
x=x!==J.Rd(v)||w.y!==v.y}else x=!1
if(x)y.gbM(z).Ze(w)}}}],["dart._internal","dart:_internal",,H,{
"^":"",
...
Gc:{
"^":"Y5;ku:fillStyle},V4:globalAlpha}",
...
C.ol.gm6(window).ml(this.gjp())},"call$1","gjp",2,0,18],
...
jN:{
"^":"a;bM>,Mp,oc,l7<,bH,vR",
px:function(a){this.vR.to(a,new A.em(this,a))},
eC:function(a){this.Mp.eC(a)
this.vR.aN(0,new A.rl(a))},
VF:function(a,b){var z,y
J.BT(a,this.bH===!0?0.5:1)
z=this.bM
y=b.BV
this.Mp.VF(a,new A.HE((z.x-y.x)*$.ae,(z.y-y.y)*$.Nd))
a.globalAlpha=1},
yh:function(a,b){var z=this.oc
this.Mp=L.DM(z,$.ae,$.Nd,null,null)
this.l7=J.UQ(J.UQ($.Is(),z),"occupiesSpace")
this.bH=J.UQ(J.UQ($.Is(),z),"transparent")
if(J.UQ(J.UQ($.Is(),z),"components")!=null)J.kH(J.UQ(J.UQ($.Is(),z),"components"),new A.uE(this))},
static:{"^":"i5",tB:function(a,b){var z=new A.jN(b,null,a,null,null,P.L5(null,null,null,J.O,F.jR))
z.yh(a,b)
return z}}},
uE:{
"^":"Tp:8;a",
call$1:function(a){this.a.px(a)}},
em:{
"^":"Tp:6;a,b",
call$0:function(){return $.ST().t(0,this.b).call$1(this.a)}},
rl:{
"^":"Tp:7;a",
call$2:function(a,b){b.eC(this.a)}}}],["input","file:///Users/Alex/Documents/Projects/Dart/RogueTest/RogueTest/web/input.dart",,K,{
"^":"",
ij:function(){var z=H.VM(new W.RO(window,C.rt.Ph,!1),[null])
...
HE:{
"^":"a;x>,y>",
Ze:function(a){this.x=a.x
this.y=a.y}}}],["","file:///Users/Alex/Documents/Projects/Dart/RogueTest/RogueTest/web/roguetest.dart",,X,{
"^":"",
Iq:[function(){var z,y
...
z.Oe=B.Pz(y)
K.ij()
C.ol.gm6(window).ml(z.gjp())},"call$0","eE",0,0,1]},1],["sprite","file:///Users/Alex/Documents/Projects/Dart/RogueTest/RogueTest/web/sprite.dart",,L,{
"^":"",
AE:{
...
if(this.ox){z=this.xY
if(typeof z!=="number")return z.D()
y=J.RE(a)
x=this.Xi
if(z>1){z=this.R
y.WE(a,x,z*this.lG,0,z,this.fg,b.gx(b),b.gy(b),this.R,this.fg)}else y.qH(a,x,b.gx(b),b.gy(b))}},
rg:function(a,b,c,d,e){var z,y
z="media/img/"+H.d(this.oc)+".png"
...
this.lG=0},
static:{DM:function(a,b,c,d,e){var z=new L.AE(a,b,c,null,null,null,0,0.5,!1)
z.rg(a,b,c,d,e)
return z}}},
ie:{
"^":"Tp:8;a",
...
x=z.R
if(typeof y!=="number")return y.Z()
z.xY=C.jn.Z(y,x)}}}],["tile","file:///Users/Alex/Documents/Projects/Dart/RogueTest/RogueTest/web/tile.dart",,K,{
"^":"",
ly:{
"^":"a;t5,Mp",
bz:function(){return $.kE().t(0,this.t5).t(0,"traversable")},
eC:function(a){this.Mp.eC(a)},
...
$.Qz=null
$.PN=null
$.SC="11111111111121111121122211222111121112111111111111"
$.k3="  {\n    \"player\": {\n      \"occupiesSpace\":true,\n      \"components\": [\n        \"Player_Move\"\n      ],\n      \"transparent\":false\n    },\n    \"ghost\": {\n      \"occupiesSpace\":true,\n      \"components\": [\n      ],\n      \"transparent\":true\n    }\n  }\n"
...
I.$lazy($,"player","re","iH",function(){return A.tB("player",new A.HE(0,0))})
I.$lazy($,"creatures","nB","Tn",function(){return H.VM([],[A.jN])})
I.$lazy($,"comps","il","ST",function(){return P.L5(null,null,null,J.O,P.EH)})
...
I.$lazy($,"objectData","i5","Is",function(){return C.xr.kV($.k3)})
...
I.$lazy($,"_tiles","u0","kE",function(){return H.B7([0,H.B7(["name","dirt","traversable",!0],P.L5(null,null,null,null,null)),1,H.B7(["name","grass","traversable",!0],P.L5(null,null,null,null,null)),2,H.B7(["name","water","traversable",!1],P.L5(null,null,null,null,null))],P.L5(null,null,null,null,null))})

init.functionAliases={}
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"WV",args:[A.jN]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"G5",void:true,args:[null]},{func:"c0",args:[W.HL]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
VX.prototype=$desc
function cp(CE,Hs,kX){this.CE=CE
this.Hs=Hs
...
if($desc instanceof Array)$desc=$desc[1]
cp.prototype=$desc
function U9(b,a){this.b=b
this.a=a}U9.builtin$cls="U9"
...
if($desc instanceof Array)$desc=$desc[1]
xI.prototype=$desc
function On(b){this.b=b}On.builtin$cls="On"
...
if($desc instanceof Array)$desc=$desc[1]
fq.prototype=$desc
function jN(bM,Mp,oc,l7,bH,vR){this.bM=bM
this.Mp=Mp
this.oc=oc
this.l7=l7
this.bH=bH
...
jN.prototype.gl7=function(){return this.l7}
...
if($desc instanceof Array)$desc=$desc[1]
ie.prototype=$desc
function ly(t5,Mp){this.t5=t5
this.Mp=Mp}ly.builtin$cls="ly"
if(!"name" in ly)ly.name="ly"
$desc=$collectedClasses.ly
if($desc instanceof Array)$desc=$desc[1]
ly.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,jW,i3,it,QP,IF,n6,Ny,Kh,TK,Y5,Gc,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,So,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,Ve,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,Lx,h4,qk,GI,Tb,Iv,WP,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,y5,JY,Pq,kx,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,QS,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,fv,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,w5,vt,cu,BD,r7,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,np,Pi,qO,xt,tG,P0,xl,Xr,Sl,Jo,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,ZQ,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,cp,U9,jg,xI,On,HF,mN,jR,ux,cH,a7,i1,xy,MH,SU,Ca,Pf,mJ,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,Tz,N6,Ta,YO,oz,b6,tj,zQ,u3,mW,lD,W0,Sw,o0,JC,f1,Uk,wI,by,QM,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,EH,An,c8,a,mE,Rn,wv,TH,Fk,RO,eu,Ov,IU,b0,Pg,Ob,GV,fq,jN,uE,em,rl,xh,zK,HE,AE,ie,ly]}